...
p = subprocess.Popen(["python3", "kmeansrun.py", "mat1.csv", "mat2.csv", str(10000), str(1000), str(5), str(10)], stdout=subprocess.PIPE)
p.communicate()
print("K-Means benchmark done")


print("Starting kmeans 2 benchmark:")
p = subprocess.Popen(["python3", "kmeansrun.py", "mat1.csv", "mat2.csv", str(1000000), str(1000), str(5), str(10)], stdout=subprocess.PIPE)
p.communicate()
print("K-Means 2 benchmark done")

print("Starting lm benchmark:")
p = subprocess.Popen(["python3", "runlm.py", "mat1.csv", str(10000), str(1000)], stdout=subprocess.PIPE)
p.communicate()
print("LM benchmark done")

print("Starting lm 2 benchmark:")
p = subprocess.Popen(["python3", "runlm.py", "mat1.csv", str(1000000), str(1000)], stdout=subprocess.PIPE)
p.communicate()
